""" This script explores publishing marker objects in ROS using Python"""
...
class visualization_publisher(Node):
    def __init__(self):
...
def main(args=None):
    ...
    simple_visualization_publisher = visualization_publisher()
